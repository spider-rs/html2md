...
#[test]
fn test_quotes() {
    let s = "<p><blockquote>here's a quote next line of it</blockquote>And some text after it</p>";
...
#[test]
fn test_blockquotes() {
    let s = "<blockquote>Quote at the start of the message</blockquote>Should not crash the parser";
